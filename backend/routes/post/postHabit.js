    ...
    fastify.post('/habit/new', {
        ...
        async (req, res) => {
            try {
                ...
                if (titleExists) {
                    return res.status(400).send({ error: 'A resource with this title already exists.' });
                }
                ...
                res.send({ message: 'The habit has been successfully created', habit: createdHabit });
            } catch {
